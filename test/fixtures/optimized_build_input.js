...
var author$project$AssetLoaderExample$view = function (model) {
	return A2(
		elm$html$Html$div,
		_List_Nil,
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						elm$html$Html$Attributes$src(author$project$AssetLoaderExample$exampleSvgUrl)
					]),
				_List_Nil)
			]));
};
...
var author$project$AssetLoaderExample$main = elm$browser$Browser$sandbox(
	{ar: elm$core$Maybe$Nothing, az: elm$core$Basics$identity, aB: author$project$AssetLoaderExample$view});
_Platform_export({'AssetLoaderExample':{'init':author$project$AssetLoaderExample$main(
